...
function playBowie(){ //program function to play the David Bowie Space Oddity sound 
    console.log("playBowie() started"); // on the backend, the David Bowie sound program starts running
    mySound2 = new sound("David-Bowie-Space-Oddity.mp3"); //the function identifies the sound and source file the program will pull to pay when button clicked
    mySound2.play(); //calling the mySound 2 object and the play function to play 
}
